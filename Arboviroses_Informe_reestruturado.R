...
SE <- as.data.frame("34")  ### Colocar a Semana Epidemiológica atual
...
AUX <- as.data.frame(str_split(RS22_2025_LACEN_PESQ_ARBO$Dt_Cadastro, 
                               pattern = " ")
)
...
RS22_2025_LACEN_PESQ_ARBO$Dt_Cadastro <- AUX$Data

###### Lubridate  para criar SE a partir de darta ######

RS22_2025_LACEN_PESQ_ARBO$SE <- epiweek(AUX$Data)


####################  uSANDO STRINGR PARA ACENTUAR A TABELA DO lacen TORNANDO-A COMPATÍVEL COM A base_ibge   ###################################

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "ARAPUA", "ARAPUÃ")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "ARIRANHA DO IVAI", "ARIRANHA DO IVAÍ")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "CANDIDO DE ABREU", "CÂNDIDO DE ABREU")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "IVAIPORA", "IVAIPORÃ")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Requisitante <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Requisitante, "IVAIPORA", "IVAIPORÃ")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "LIDIANOPOLIS", "LIDIANÓPOLIS")

RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia <- str_replace(RS22_2025_LACEN_PESQ_ARBO$Municipio_Residencia, "RIO BRANCO DO IVAI", "RIO BRANCO DO IVAÍ")
...
RS22_2025_LACEN_PESQ_ARBO[, 9] <- as.factor(RS22_2025_LACEN_PESQ_ARBO[, 9])

RS22_2025_LACEN_PESQ_ARBO[, 23] <- as.factor(RS22_2025_LACEN_PESQ_ARBO[, 23])

RS22_2025_LACEN_PESQ_ARBO[, 24] <- as.factor(RS22_2025_LACEN_PESQ_ARBO[, 24])
...
AUX <- as.data.frame(str_split(RS22_2025_LACEN_SOROLOGIA$Dt_Cadastro, 
                               pattern = " ")
)
...
RS22_2025_LACEN_SOROLOGIA$Dt_Cadastro <- AUX$Data

###### Lubridate  para criar SE a partir de data ######

RS22_2025_LACEN_SOROLOGIA$SE <- epiweek(AUX$Data)

####################  USANDO STRINGR PARA ACENTUAR A TABELA DO lacen TORNANDO-A COMPATÍVEL COM A base_ibge   ###################################

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "ARAPUA", "ARAPUÃ")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "ARIRANHA DO IVAI", "ARIRANHA DO IVAÍ")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "CANDIDO DE ABREU", "CÂNDIDO DE ABREU")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "IVAIPORA", "IVAIPORÃ")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "LIDIANOPOLIS", "LIDIANÓPOLIS")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "RIO BRANCO DO IVAI", "RIO BRANCO DO IVAÍ")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "ROSARIO DO IVAI", "ROSÁRIO DO IVAÍ")

RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia <- str_replace(RS22_2025_LACEN_SOROLOGIA$Municipio_Residencia, "SAO JOAO DO IVAI", "SÃO JOÃO DO IVAÍ")

####################   Transformando colunas em fatores para o for loop funcionar   ##################################

RS22_2025_LACEN_SOROLOGIA[, 9] <- as.factor(RS22_2025_LACEN_SOROLOGIA[, 9])
...
colnames(RS22_2025_SE_PESQ_ARB)[1] <- "Município" 

RS22_2025_SE_PESQ_ARB[,1] <- BASE_IBGE[which(BASE_IBGE$RS == RS), 3]

colnames (RS22_2025_SE_PESQ_ARB)[2:54] <- c(1:53)
...
RS22_2025_SE_PESQ_ARB[(nrow(RS22_2025_SE_PESQ_ARB)+1),2:54] <- apply(RS22_2025_SE_PESQ_ARB[,2:54], 2, sum)

RS22_2025_SE_PESQ_ARB[nrow(RS22_2025_SE_PESQ_ARB),1] <- "Total"
...
colnames(RS22_2025_SE_PESQ_ARB_DETECTAVEL)[1] <- "Município" 

RS22_2025_SE_PESQ_ARB_DETECTAVEL[,1] <- BASE_IBGE[which(BASE_IBGE$RS == 22), 3]

colnames (RS22_2025_SE_PESQ_ARB_DETECTAVEL)[2:54] <- c(1:53)
...
RS22_2025_SE_PESQ_ARB_DETECTAVEL[(nrow(RS22_2025_SE_PESQ_ARB_DETECTAVEL)+1),2:54] <- apply(RS22_2025_SE_PESQ_ARB_DETECTAVEL[,2:54], 2, sum)

RS22_2025_SE_PESQ_ARB_DETECTAVEL[nrow(RS22_2025_SE_PESQ_ARB_DETECTAVEL),1] <- "Total"
...
colnames(RS22_2025_SE_US)[1] <- "Município" 

RS22_2025_SE_US[,1] <- BASE_IBGE[which(BASE_IBGE$RS == RS), 3]

colnames (RS22_2025_SE_US)[2:54] <- c(1:53)
...
RS22_2025_SE_US[(nrow(RS22_2025_SE_US)+1),2:54] <- apply(RS22_2025_SE_US[,2:54], 2, sum)

RS22_2025_SE_US[nrow(RS22_2025_SE_US),1] <- "Total"
...
colnames(RS22_2025_SE_US_DETECTAVEL)[1] <- "Município" 

RS22_2025_SE_US_DETECTAVEL[,1] <- BASE_IBGE[which(BASE_IBGE$RS == RS), 3]

colnames (RS22_2025_SE_US_DETECTAVEL)[2:54] <- c(1:53)
...
colnames(RS22_2025_SE_SOROLOGIA)[1] <- "Município" 

RS22_2025_SE_SOROLOGIA[,1] <- BASE_IBGE[which(BASE_IBGE$RS == RS), 3]

colnames (RS22_2025_SE_SOROLOGIA)[2:54] <- c(1:53)
...
colnames(RS22_2025_SE_SOROLOGIA_REAGENTE)[1] <- "Município" 

RS22_2025_SE_SOROLOGIA_REAGENTE[,1] <- BASE_IBGE[which(BASE_IBGE$RS == RS), 3]

colnames (RS22_2025_SE_SOROLOGIA_REAGENTE)[2:54] <- c(1:53)
...
RS22_2025_SE_SOROLOGIA_REAGENTE[, 13] <- as.numeric(RS22_2025_SE_SOROLOGIA_REAGENTE[, 13])

####CORREÇÔES####

## RS22_2025_SE_SOROLOGIA_REAGENTE[13, 16] <- 1
...
AUX <- RS22_2025_SE_US[6,]

AUX[2, ] <- colnames(RS22_2025_SE_PESQ_ARB)
...
RS22_GRAF_2025_US_TOTAL <- ggplot(AUX, aes(x = Sem_EPI, y = IVAIPORÃ))  + 
...
AUX_2 <- as.data.frame(RS22_2025_SE_US_DETECTAVEL[6, ])
...
RS22_GRAF_2025_US_DETEC <-  ggplot(AUX, aes(x = Sem_EPI, y = PORC_US_DETEC))  + 
  labs(caption = Fonte_1, 
       x = "Semana Epidemiológica",
...
RS22_2025_GRAF_SORO_TOTAL <- ggplot(AUX, aes(x = Sem_EPI, y = Total))  + 
  labs(caption = Fonte_1, 
       x = "Semana Epidemiológica",
...
AUX$Total <- t(RS22_2025_SE_SOROLOGIA[17, 2:54])
...
RS22_2025_GRAF_SORO_REAG <- ggplot(AUX, aes(x = Sem_EPI, y = PORC_SORO_REAG))  + 
  labs(caption = Fonte_1, 
       x = "Semana Epidemiológica",
...
for(i in BASE_IBGE[(which(BASE_IBGE$RS == RS)), 3]){
  ...
  ###Sorologia/Município###  
  AUX[which(AUX$Município == i), 5] <- as.integer(RS22_2025_LACEN_SOROLOGIA %>% 
                                                    filter(Municipio_Residencia == i) %>%   
                                                    count()
  )   
  
  ###Sorologia reagente/Município##  
  AUX[which(AUX$Município == i), 6] <- as.integer(RS22_2025_LACEN_SOROLOGIA %>% 
                                                    filter(Municipio_Residencia == i,
                                                           Resultado == "Reagente ") %>%   
                                                    count()
  )
...
PR_2025_GRAF_SINAIS_CHIK <- ggplot (AUX_GRAF, 
  ...
  labs(caption = Fonte, 
       x = "Sintomas",
       y = "Número de Casos",
       title = "SINAIS/SINTOMAS EM CASOS NOTIFICADOS E CONFIRMADOS PARANÁ - 2025",
...
PR_DENGUE_2025_GRAF_SINAIS <- ggplot (AUX_GRAF, 
  ...
  labs(caption = Fonte, 
       x = "Sintomas",
       y = "Número de Casos",
       title = "SINAIS/SINTOMAS NOS CASOS NOTIFICADOS E CONFIRMADOS PARANÁ - 2025",
       subtitle = "Sinais Clínicos/Sintomas em Notificações de DENGUE Assinalados no Campo 33 da Ficha do SINAN") +
  geom_bar(
    aes( y = Notificados, fill = "Notificados"),
    stat = "identity",
